...
<body>
            ...
            <ul class="nav__menu">
              ...
              <li class="nav__dropdown">
                ...
                <ul class="nav__dropdown-menu">
                  ...
                  <li><a href="portfolio-3.html">Stato Progetto Formativo</a></li>
  ...
  <div class="main-wrapper oh">
    ...
    <section class="section-wrap bg-light pb-90">
      <div class="container">
        <div class="row">
          <div class="col-md-4 mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
          ...
          <div class="col-md-4 mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInUp;">
            <div class="box-shadow">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
            <div class="box-shadow">
