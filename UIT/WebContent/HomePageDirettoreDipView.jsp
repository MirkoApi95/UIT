...
<body>
				...
				<div class="flex-parent">
					...
					<nav id="navbar-collapse"
						...
						<ul class="nav__menu">
							...
							<li class="nav__dropdown"><a href="#">Benvenuto <%=utente.getNome() +" "+utente.getCognome() %></a>
	...
	<div class="main-wrapper oh">
		...
		<section class="section-wrap bg-light pb-90">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-xs-5  wow fadeInUp" data-wow-duration="1s"
						data-wow-delay="0.1s"
					...
					<div class="col-md-4 col-xs-5 col-md-4 mb-30 wow fadeInUp"
