...
public class VisualizzaAzienda extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	  ArrayList <TutorAziendale> arrayaziende=new ArrayList<TutorAziendale>();
      arrayaziende=TutorAziendaleDao.selectTutornames();
      request.setAttribute("arrayaziende", arrayaziende);
      RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ListaAziendeView.jsp");
