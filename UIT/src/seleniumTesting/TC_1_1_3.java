...
public class TC_1_1_3 {
   ...
   * 
   * @author Mirko
   * La calsse testa testa la registrazione inserendo come campo errato api22 (password troppo corta)
   */
  public static void main(String[] args) {
    {
      ...
      inputpassword.sendKeys("api22");
      confirm_password= driver.findElement(By.id("confirm_password"));
      confirm_password.sendKeys("api22");
