			...
			if(u!=null)
			{
				if(u.getPassword().equals(password)&&u.getEmail().equals(email)){
					...
					case "@studenti.unisa.it": 
						request.getRequestDispatcher("HomePageTirocinanteView.jsp").forward(request, response);
						break;
					case "@docenti.unisa.it":
						request.getRequestDispatcher("HomePageTutorUniversitarioView.jsp").forward(request, response);
						break;
					case "@azienda.unisa.it":
						request.getRequestDispatcher("HomePageTutorAziendaleView.jsp").forward(request, response);
						break;
